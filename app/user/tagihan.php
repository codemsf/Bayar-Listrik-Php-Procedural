  ...
  <section class="" style="margin-top: 10%">
    <div class="container">
      <div class="text-center">
          ...
          <p>Data tagihan anda (<?php echo  ucwords($_SESSION['user']['nama']);  echo $_SESSION['user']['norek']; ?>)</p>
        </div>
      <div>
        <table class="table table-bordered text-center ">
          ...
          <tbody>
            ...
            $data=$conn->query("SELECT * FROM `tagihan` LEFT OUTER JOIN pelanggan ON tagihan.id_pelanggan = pelanggan.id_pelanggan WHERE tagihan.id_pelanggan = '$uid' AND status = '0' ORDER BY tagihan.tahun , tagihan.bulan ASC");
            ...
            <td>Rp.<?php echo number_format($hrg * $row['meter']);  ?> (belum biaya Admin)</td>
