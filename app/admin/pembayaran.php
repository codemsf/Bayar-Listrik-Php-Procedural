...
<div id="page-content-container">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12"><h1>Halaman Pembayaran (Payment)</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="text-center">
     <table class="table table-bordered ">
      ...
      <tbody>
        <?php 
        $no=1;
        $take =$conn->query("SELECT * FROM pembayaran , pelanggan WHERE pembayaran.id_pelanggan = pelanggan.id_pelanggan");
